...
//            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(itemId == 1) {
            ...
            Toast.makeText(MainFragmentActivity.this, "获取进度  " + XmPlayerManager.getInstance(MainFragmentActivity.this).getHistoryPos(XmPlayerManager.getInstance(MainFragmentActivity.this).getCurrSound().getDataId()), Toast.LENGTH_SHORT).show();
        } else if(itemId == 6) {
